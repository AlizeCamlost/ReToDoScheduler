...
- [specs/norn-mobile-structure.md](specs/norn-mobile-structure.md): Norn iOS_ng 的当前目录快照、目标类型地图、调用关系和 feature 提交拓扑，并同步记录根容器背景、bottom+horizontal edge-to-edge 分页裁剪壳、Sequence page scoped safeAreaInset、卡片本体拖拽、中性时间线笔触与详情动作层级收束。当前实施状态：F13 已完成。最后更新：2026-03-24
